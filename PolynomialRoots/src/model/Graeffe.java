...
public class Graeffe {
    ...
    public Complex[] raicesComplejas=new Complex[4]; 
...
//valores de los sucesivos términos
    ...
    public Complex valorPolinomio(Complex x){
        Complex y=new Complex();
        for(int i=0; i<n+1; i++){
            y=Complex.suma(y, Complex.producto(a[0][i], 
               Complex.potencia(x, (n-i))));
        }
        return y;
    }
...
//valor absoluto de la raíz
    ...
    private void unaRaizCompleja(){
        ...
        raicesComplejas[0]=new Complex(u, v);
        raicesComplejas[1]=new Complex(u, -v);
    }
    private void dosRaicesComplejas(){
        ...
        raicesComplejas[0]=new Complex(u1, v1);
        raicesComplejas[1]=new Complex(u1, -v1);
        raicesComplejas[2]=new Complex(u2, v2);
        raicesComplejas[3]=new Complex(u2, -v2);
    }
